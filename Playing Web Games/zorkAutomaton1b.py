...
# Open the website
driver.get('https://www.ifiction.org/games/playz.php?cat=2&game=386&mode=html')

def loadWalkthrough():
	walkthrough = [	

# Introduction
# I do not believe that there is a definitive highest points / least moves walkthrough because of
# the random appearance of the Thief. Though this walkthrough does not visit every area it is 
# played in a reasonably natural way as an adventurer might who had done some preliminary 
# exploration, and who wanted to deal with sources of danger expeditiously.
...
#At the start of the game you are at the West Side of the White House. 
	...
	"Up",
	"Turn On the Lamp",
	"Get the Knife and the Rope",
	"Go Down",
	"Turn the Lamp Off",
	"Go West",
	"Drop the Knife and the Rope",
	"Open Trophy Case",
...
#"Part 3  Troll, Cyclops and Thief; Coins, Chalice, Canary and Bauble
	...
	"Turn on the Lamp",
	"Go East",
	# This would be first automated part on second program
...
#	"pause",
	...
	"Go East",
	"Turn Off the Lamp",
	"Put the Bag in the Trophy Case",
	"Drop the Sword",
	"Get the Knife.",
	"Turn On the Lamp",
	"Go West",
	...
	"Go Up",
"pause",
"Kill the Thief with the Knife", #It may take several repetitions of 'Kill the Thief with the Knife' to do it, and you may get killed yourself.
"pause",
"Get the Jewelled Egg", # which is open to show a Golden Canary within it, 
"get the Silver Chalice", #and all the other objects in the room. 
"get all",
#Take them 
"East",# to the Living Room. It may take more than one trip. 
"Turn off lamp", #and 
"Drop the Lamp",
"Get the Canary",
"Put the Jewelled Egg, the Silver Chalice and the other Treasures into the Trophy Case.",
"Go East", # and 
"East", # again(through the Window) to Behind the House, then 
"North", # through the North Side to the Forest Path. 
"Climb the Tree", #and 
"Wind the Golden Canary",# The Singing Bird will drop the Brass Bauble on your head. 
"Go Down the Tree", # and 
"get the Bauble",
"Go South", # through the North Side and 
"East", # through Behind House. 
"Enter the House",# then 
"go West", # into the Living Room. 
"Put the Golden Canary and the Brass Bauble into the Trophy Case",
	"pause",
